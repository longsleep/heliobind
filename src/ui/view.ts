...
export const dom = {
  ...
  cipherKeyRow: el("cipher-key-row"),
  cipherIv: el<HTMLInputElement>("cipher-iv"),
  cipherIvRow: el("cipher-iv-row"),
  ...
  registerSpace: el<HTMLSelectElement>("register-space"),
  registerStart: el<HTMLInputElement>("register-start"),
  registerCount: el<HTMLInputElement>("register-count"),
  registerRead: el<HTMLButtonElement>("register-read"),
  registerVersions: el<HTMLButtonElement>("register-versions"),
  deviceVersions: el<HTMLElement>("device-versions"),
